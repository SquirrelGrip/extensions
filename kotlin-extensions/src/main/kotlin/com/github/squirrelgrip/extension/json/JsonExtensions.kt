...
import com.github.squirrelgrip.util.format.toJsonSequence
import com.github.squirrelgrip.util.format.toJsonStream
...
inline fun <reified T> String.toJsonStream(): Stream<T> = this.toJsonParser<T>().toJsonStream<T>()
inline fun <reified T> InputStream.toJsonStream(): Stream<T> = this.toJsonParser<T>().toJsonStream<T>()
inline fun <reified T> Reader.toJsonStream(): Stream<T> = this.toJsonParser<T>().toJsonStream<T>()
inline fun <reified T> URL.toJsonStream(): Stream<T> = this.toJsonParser<T>().toJsonStream<T>()
inline fun <reified T> ByteArray.toJsonStream(): Stream<T> = this.toJsonParser<T>().toJsonStream<T>()
inline fun <reified T> ByteArray.toJsonStream(offset: Int, length: Int): Stream<T> = this.toJsonParser<T>(offset, length).toJsonStream<T>()

inline fun <reified T> File.toJsonStream(): Stream<T> = this.toJsonParser<T>().toJsonStream<T>()
inline fun <reified T> Path.toJsonStream(): Stream<T> = this.toJsonParser<T>().toJsonStream<T>()

inline fun <reified T> String.toJsonSequence(): Sequence<T> = this.toJsonParser<T>().toJsonSequence()
inline fun <reified T> InputStream.toJsonSequence(): Sequence<T> = this.toJsonParser<T>().toJsonSequence<T>()
inline fun <reified T> Reader.toJsonSequence(): Sequence<T> = this.toJsonParser<T>().toJsonSequence<T>()
inline fun <reified T> URL.toJsonSequence(): Sequence<T> = this.toJsonParser<T>().toJsonSequence<T>()
inline fun <reified T> ByteArray.toJsonSequence(): Sequence<T> = this.toJsonParser<T>().toJsonSequence<T>()
inline fun <reified T> ByteArray.toJsonSequence(offset: Int, length: Int): Sequence<T> =
    this.toJsonParser<T>(offset, length).toJsonSequence<T>()

inline fun <reified T> File.toJsonSequence(): Sequence<T> = this.toJsonParser<T>().toJsonSequence<T>()
inline fun <reified T> Path.toJsonSequence(): Sequence<T> = this.toJsonParser<T>().toJsonSequence<T>()

inline fun <reified T> String.toJsonParser(): JsonParser = Json.objectReader<T>().createParser(this)
inline fun <reified T> InputStream.toJsonParser(): JsonParser = Json.objectReader<T>().createParser(this)
inline fun <reified T> Reader.toJsonParser(): JsonParser = Json.objectReader<T>().createParser(this)
inline fun <reified T> URL.toJsonParser(): JsonParser = Json.objectReader<T>().createParser(this)
inline fun <reified T> ByteArray.toJsonParser(): JsonParser = Json.objectReader<T>().createParser(this)
inline fun <reified T> ByteArray.toJsonParser(offset: Int, length: Int): JsonParser = Json.objectReader<T>().createParser(this, offset, length)

inline fun <reified T> File.toJsonParser(): JsonParser = Json.objectReader<T>().createParser(this)
inline fun <reified T> Path.toJsonParser(): JsonParser = Json.objectReader<T>().createParser(this.toFile())
